...
void                         set_x393_sensi2c_status_ctrl        (x393_status_ctrl_t d, int sens_num){writel(0x4000100c + 0x100 * sens_num, (u32) d);} // Setup sensor i2c status report mode
x393_status_ctrl_t           get_x393_sensi2c_status_ctrl        (int sens_num)      {return (x393_status_ctrl_t) readl(0x4000100c + 0x100 * sens_num);}
